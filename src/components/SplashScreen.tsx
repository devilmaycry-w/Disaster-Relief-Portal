...
const SplashScreen: React.FC<{ onContinue?: () => void }> = ({ onContinue }) => {
  ...
  return (
    <div className="flex-1 flex items-center justify-center p-6 bg-gradient-to-br from-blue-50 via-white to-blue-100 animate-fadeIn">
      <div className="max-w-md w-full text-center">
        ...
        <div className="space-y-4 animate-fadeIn" style={{ animationDelay: '0.6s' }}>
          ...
          <button
            ...
            disabled={isLoading}
            className="w-full btn-secondary py-4 text-lg flex items-center justify-center space-x-3 disabled:opacity-50 disabled:cursor-not-allowed"
          >
