...
const ProfilePage: React.FC = () => {
  ...
  // Tabs: only show Settings if not guest
  const tabs = [
  ...
  return (
    <div className="flex-1 p-4 sm:p-6 bg-gradient-to-br from-blue-50 via-white to-blue-100/60 min-h-screen flex flex-col items-center animate-fadeIn">
            ...
            <div className="relative mb-6">
              ...
              {!isGuest && (
                <button 
                  ...
                  onClick={() => alert('Edit profile coming soon!')} // TODO: Replace with real edit modal
            ...
            <div className="flex justify-center gap-3 mt-4">
              {!isGuest && (
                <button 
                  ...
                  className="flex items-center gap-1.5 py-2 px-4 bg-gray-100 text-gray-700 rounded-lg text-sm font-medium hover:bg-gray-200 transition-colors"
                >
                  <LogOut size={16} />
                  Sign Out
                </button>
          ...
          <div className="flex items-center justify-between p-4 bg-blue-50 rounded-xl mb-4 border border-blue-100">
            ...
            {state.alerts && state.alerts.length > 0 && (
              isGuest ? (
                ...
                >
                  <span className="text-xs font-semibold text-blue-500">Mark as Read</span>
                </button>
              )
            )}
          </div>
