...
const BottomNav: React.FC<{ 
  ...
  return (
    <nav
      className="glass-strong border-t border-white/20 p-3 fixed bottom-0 left-0 right-0 z-50 md:hidden shadow-2xl animate-slideUp"
      role="navigation"
      ...
      <div className="max-w-3xl mx-auto flex justify-between items-center">
        ...
        >
          <div className={`p-1 rounded-lg relative ${active === 'alerts' ? 'bg-red-100' : ''}`}>
            {unreadCount > 0 ? (
              <AlertTriangle size={22} className="animate-pulse-subtle" aria-hidden="true" />
            ) : (
